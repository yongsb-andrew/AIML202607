...
urllib.request.urlretrieve("https://raw.githubusercontent.com/datasets/co2-ppm/master/data/co2-mm-mlo.csv", full_path)
print()
print("File has been downloaded!")
print(f"Downloaded full file path: {full_path}")
